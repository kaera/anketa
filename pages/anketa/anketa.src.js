            ...
            content: [
                {
                    ...
                    content: 'Опыта в разработке интерфейсов как такового нет. До последнего времени работала системныи администратором, по работе писала небольшие скрипты. Недавно начала изучать web-программирование, сделала тестовый проект на RubyOnRails. Немного участвовала в оформлении сайта lvee.org.'
                },
                {
                    elem: 'item',
